...
migrations_logger = MyLogger(
    os.path.join(log_dir, "logs", "migrate"), app_name
)
web_logger = MyLogger(
    os.path.join(log_dir, "logs", "web"), app_name
)
rabbitmq_logger = MyLogger(
    os.path.join(log_dir, "logs", "rabbitmq"), app_name
)
